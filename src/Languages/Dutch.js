...
const Dutch = () => (
    <div>
        ...
        <p>Ingangsdatum: October 22, 2019</p>


        <p>Wearlog LLC ("ons", "wij" of "onze") beheert de WearLog mobiele App ("hierna genoemd Dienst").</p>
        ...
        <p>Definities</p>
             ...
             <p>
                <p> Dienst </p>
                <p>Onder dienst verstaan wij de WearLog mobiele App beheerd door Wearlog LLC</p>
             </p>
             <p>
             ...
             <p>
                <p> Gegevensverwerkers (of Dienstverleners) </p>
        ...
        <p>Soorten gegevens die worden verzameld</p>
        ...
        <p>Wanneer u onze Dienst gebruikt, kunnen wij u vragen ons bepaalde persoonlijk identificeerbare informatie te verstrekken die kan worden gebruikt om contact op te nemen met u of om u te identificeren ("Persoonsgegevens"). Deze persoonlijk identificeerbare informatie kan omvatten maar is niet beperkt tot:</p>
             ...
             <p>E-mailadres </p>     <p>Voor- en achternaam </p>     <p>Telefoonnummer </p>         <p>Cookies en Gebruiksgegevens </p>
        ...
        <p>Voorbeelden van cookies die wij gebruiken:</p>
             ...
             <p> Sessiecookies.  Wij gebruiken Sessiecookies om onze Dienst te beheren. </p>
             <p> Voorkeurcookies.   Wij gebruiken Voorkeurcookies om uw voorkeuren en uiteenlopende instellingen bij te houden. </p>
             <p> Veiligheidscookies.  Wij gebruiken Veiligheidscookies voor veiligheidsdoeleinden. </p>
         

        <p>Gebruik van gegevens</p>
        <p>Wearlog LLC gebruikt de verzamelde gegevens voor uiteenlopende doeleinden:</p>
         
             <p>Om onze Dienst te leveren en te onderhouden </p>
             <p>Om u wijzigingen in onze Dienst te melden </p>
             <p>Om u de mogelijkheid te bieden om, indien gewenst, deel te nemen aan de interactieve functies van onze Dienst </p>
             <p>Om onze klanten steun te verlenen </p>
             <p>Om analyse- of waardevolle gegevens te verzamelen die we kunnen toepassen om onze Dienst te verbeteren </p>
             <p>Om toezicht te houden op het gebruik van onze Dienst </p>
             <p>Om technische problemen te detecteren, te voorkomen en te behandelen </p>
         


        <p>Juridische basis voor de verwerking van Persoonsgegevens onder de Algemene verordening persoonsgegevens (AVG)</p>
        <p>Als u inwoner bent van de Europese Economische Ruimte (EER) hangt de juridische basis van, Wearlog LLC voor de verzameling en het gebruik van de persoonsgegevens zoals beschreven in dit Privacybeleid af van de Persoonsgegevens die wij verzamelen en de specifieke context waarin wij ze verzamelen.</p>
        <p>Wearlog LLC kan uw Persoonsgegevens gebruiken omdat:</p>
         
             <p>Wij een contract moeten afsluiten met u </p>
             <p>U ons de toestemming hebt gegeven </p>
             <p>De verwerking in ons legitiem belang is en niet wordt opgeheven door uw rechten </p>
             <p>In naleving van de wet </p>
         


        <p>Bewaren van gegevens</p>
        <p>Wearlog LLC bewaart uw Persoonsgegevens slechts zolang dit nodig is voor de doeleinden vermeld in dit Privacybeleid. Wij bewaren en gebruiken uw Persoonsgegevens in de mate dit noodzakelijk is om te voldoen aan onze wettelijke verplichtingen (bijv. als we uw gegevens moeten bewaren in naleving van de geldende wetgeving), om geschillen op te lossen en om onze wettelijke overeenkomsten en beleid toe te passen.</p>
        <p>Wearlog LLC bewaart uw Gebruiksgegevens ook voor interne analytische doeleinden. Gebruiksgegevens worden gewoonlijk voor een kortere periode bewaard, tenzij deze gegevens worden gebruikt om de veiligheid te versterken of de werking van onze Dienst te verbeteren, of indien wij wettelijk verplicht zijn deze gegevens gedurende een langere periode te bewaren.</p>
        ...
        <p>Wearlog LLC zal alle redelijkerwijs noodzakelijke stappen ondernemen om ervoor te zorgen dat uw gegevens veilig en in overeenstemming met dit Privacybeleid worden behandeld en dat uw Persoonsgegevens nooit worden overgedragen aan een organisatie of een land als er geen gepaste controles zijn ingesteld, inclusief de veiligheid van uw gegevens en andere persoonsgegevens.</p>

        <p>Openbaarmaking van gegevens</p>

        <p>Openbaarmaking voor wetshandhavingsdoeleinden</p>
        <p>In bepaalde omstandigheden kan Wearlog LLC verplicht worden uw Persoonsgegevens openbaar te maken indien dit wettelijk wordt verplicht of op verzoek van overheidsinstanties (bijv. een rechtbank of overheidsorgaan).</p>

        <p>Wettelijke vereisten</p>
        <p>Wearlog LLC kan uw Persoonsgegevens openbaar maken als het te goeder trouw de mening is toegedaan dat een dergelijke handeling noodzakelijk is:</p>
         
             <p>Om te voldoen aan een wettelijke verplichting </p>
             <p>Om de rechten en eigendom van Wearlog LLC te beschermen en te verdedigen </p>
             <p>Om mogelijke misstanden te voorkomen of te onderzoeken in verband met de Dienst </p>
             <p>Om de persoonlijke veiligheid van gebruikers van de Dienst of het publiek te beschermen </p>
             <p>Als bescherming tegen juridische aansprakelijkheid </p>
         

        <p>Veiligheid van gegevens</p>
        ...
        <p>Uw rechten inzake gegevensbescherming onder de Algemene verordening persoonsgegevens (AVG)</p>
        <p>Als u inwoner bent van de Europese Economische Ruimte (EER) hebt u bepaalde rechten op het gebied van gegevensbescherming. Wearlog LLC streeft er naar redelijke maatregelen te nemen om u de mogelijkheid te bieden het gebruik van uw Persoonsgegevens te corrigeren, te wijzigen, te verwijderen of te beperken.</p>
        ...
        <p>In bepaalde omstandigheden hebt u de volgende rechten op het gebied van gegevensbescherming:</p>
             ...
             <p>
                <p> Het recht uw toestemming in te trekken.  U hebt ook het recht uw toestemming op elk moment in te trekken waar Wearlog LLC uw persoonsgegevens verwerkt op basis van uw toestemming.</p>
             </p>
        ...
        <p>Wijzigingen aan dit Privacybeleid</p>
        ...
        <p>Als u vragen hebt over dit Privacybeleid kunt u contact opnemen met ons:</p>
             ...
             <p>Via email: info@wearlog.com </p>
             <p>Via deze pagina op onze website: wearlog.com </p>
