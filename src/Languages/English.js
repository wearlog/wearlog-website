...
const English = () => (
    <div>
        ...
        <p>Wearlog LLC ("us", "we", or "our") operates the WearLog mobile application (hereinafter referred to as the "Service").</p>
        ...
        <p> Service </p>
        <p>Service is the WearLog mobile application operated by Wearlog LLC</p>
        ...
        <p>While using our Service, we may ask you to provide us with certain personally identifiable information that can be used to contact or identify you ("Personal Data"). Personally identifiable information may include, but is not limited to:</p>
             ...
             <p>Email address </p>     <p>First name and last name </p>     <p>Phone number </p>         <p>Cookies and Usage Data </p>
        ...
        <p>Use of Data</p>
        <p>Wearlog LLC uses the collected data for various purposes:</p>
        ...
        <p>If you are from the European Economic Area (EEA), Wearlog LLC legal basis for collecting and using the personal information described in this Privacy Policy depends on the Personal Data we collect and the specific context in which we collect it.</p>
        <p>Wearlog LLC may process your Personal Data because:</p>
        ...
        <p>Wearlog LLC will retain your Personal Data only for as long as is necessary for the purposes set out in this Privacy Policy. We will retain and use your Personal Data to the extent necessary to comply with our legal obligations (for example, if we are required to retain your data to comply with applicable laws), resolve disputes and enforce our legal agreements and policies.</p>
        <p>Wearlog LLC will also retain Usage Data for internal analysis purposes. Usage Data is generally retained for a shorter period of time, except when this data is used to strengthen the security or to improve the functionality of our Service, or we are legally obligated to retain this data for longer periods.</p>
        ...
        <p>Wearlog LLC will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.</p>

        <p>Disclosure of Data</p>

        <p>Disclosure for Law Enforcement</p>
        <p>Under certain circumstances, Wearlog LLC may be required to disclose your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>

        <p>Legal Requirements</p>
        <p>Wearlog LLC may disclose your Personal Data in the good faith belief that such action is necessary to:</p>

        <p>To comply with a legal obligation </p>
        <p>To protect and defend the rights or property of Wearlog LLC </p>
        ...
        <p>If you are a resident of the European Economic Area (EEA), you have certain data protection rights. Wearlog LLC aims to take reasonable steps to allow you to correct, amend, delete or limit the use of your Personal Data.</p>
        ...
        <p>In certain circumstances, you have the following data protection rights:</p>
             ...
             <p>
                <p> The right to withdraw consent.  You also have the right to withdraw your consent at any time where Wearlog LLC relied on your consent to process your personal information.</p>
             </p>
        ...
        <p>If you have any questions about this Privacy Policy, please contact us:</p>
             ...
             <p>By email: info@wearlog.com </p>
             <p>By visiting this page on our website: wearlog.com </p>
